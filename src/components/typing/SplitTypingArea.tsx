...
export function SplitTypingArea({
  ...
  useEffect(() => {
    const activeChar =
      document.getElementById('active-char');
  ...
  return (
    <div
      className="w-full h-[100dvh] min-h-screen flex flex-col md:flex-row bg-slate-900 overflow-hidden"
    >

      {/* =====================================================
          LEFT SIDE — ORIGINAL PASSAGE
      ====================================================== */}
      ...
      >
        ...
        <h3 className="text-xl font-bold text-slate-300 mb-5 flex items-center shrink-0">
        ...
        >
          {characters.map((item, index) => {
            ...
            if (item.state === 'correct') {
              charClass = settings.highlightCorrect
                ? 'text-slate-100'
                : 'text-slate-500';
            }

            if (item.state === 'incorrect') {
              charClass = settings.highlightError
            ...
            return (
              <span
                ...
                className={cn(
                  ...
                  charClass,
                  isCurrent
                    ? 'bg-yellow-500/30 text-slate-100 border-b-2 border-yellow-500'
                    : ''
                )}
              >
                {item.char}
      ...
      >
        ...
        >
          ...
          <div
            ...
            "
          >
            <span className="text-xs text-slate-400 uppercase font-bold tracking-wider mr-2">
              Time
            </span>
